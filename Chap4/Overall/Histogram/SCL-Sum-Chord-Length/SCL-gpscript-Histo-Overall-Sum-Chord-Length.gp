...
## ==================================================================
set title "Overall Total Sum-Chord-Length SCL for each curve \n at Feedrate Commands FC10, FC20, FC30 and FC40 \n with all lamda = 0.18" 

set xlabel "Curve Type"
set ylabel "Total Sum-Chord-Length SCL (mm)"
...
set yrange [ 0.00000 : 620 ] noreverse writeback
...
plot 'SCL-data-for-Histo-Overall-Sum-Chord-Length.txt' using 1:xtic(1) title "CURVE-TYPE", '' using 2 title "FC10", '' using 3 title "FC20", '' using 4 title "FC30", '' using 5 title "FC40"

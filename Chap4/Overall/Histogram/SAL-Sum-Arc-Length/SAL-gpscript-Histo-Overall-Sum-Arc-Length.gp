...
## ==================================================================
set title "Overall Total Sum-Arc-Length SAL for each curve \n at Feedrate Commands FC10, FC20, FC30 and FC40 \n with all lamda = 0.18" 

set xlabel "Curve Type"
set ylabel "Total Sum-Arc-Length SAL (mm)"
...
set yrange [ 0.00000 : 1200 ] noreverse writeback
...
plot 'SAL-data-for-Histo-Overall-Sum-Arc-Length.txt' using 1:xtic(1) title "CURVE-TYPE", '' using 2 title "FC10", '' using 3 title "FC20", '' using 4 title "FC30", '' using 5 title "FC40"

...
## ==================================================================
set title "Overall Total Sum-Arc-Area SAA on Log 10 for each curve \n at Feedrate Commands FC10, FC20, FC30 and FC40 \n with all lamda = 0.18" 

set xlabel "Curve Type"
set ylabel "Log 10 Total Sum-Arc-Area SAA (mm2)"
...
set logscale y 10
set yrange [ 1E-10 : 1E+4] noreverse writeback

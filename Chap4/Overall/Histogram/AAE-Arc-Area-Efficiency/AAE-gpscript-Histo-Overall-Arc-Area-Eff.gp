...
## ==================================================================
set title "Overall Arc-Area-Efficience AAE for each curve \n at Feedrate Commands FC10, FC20, FC30 and FC40 \n with all lamda = 0.18" 

set xlabel "Curve Type"
set ylabel "Log 10 Arc-Area-Efficiencvy AAE = SAA/SCL (mm)"
...
set logscale y 10
set yrange [ 1E-10 : 1E-2] noreverse writeback

## set yrange [ 0 : 1E-4 ] noreverse writeback
...
plot 'AAE-data-for-Histo-Arc-Area-Eff.txt' using 1:xtic(1) title "CURVE-TYPE", '' using 2 title "FC10", '' using 3 title "FC20", '' using 4 title "FC30", '' using 5 title "FC40"

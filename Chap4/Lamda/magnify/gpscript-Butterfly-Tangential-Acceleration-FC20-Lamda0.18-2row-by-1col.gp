...
set multiplot layout 2,1 columns
    ...
    set title "Lamda = 0.18 Butterfly FC20 Part1/2 "
    plot "BUTTERFLY-data-Lamda-018-FC20-U-vs-Tang-Accn.txt" using 2:13 with lines linecolor black title "tang-accn"

    set xrange [ 0.70 :  + 0.80]
    set yrange [ -60.00 :  +60.00]
    set title "continue Lamda = 0.18 Butterfly FC20 Part 2/2"
    plot "BUTTERFLY-data-Lamda-018-FC20-U-vs-Tang-Accn.txt" using 2:13 with lines linecolor black title "tang-accn"

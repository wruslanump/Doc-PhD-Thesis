...
set multiplot layout 2,1 columns
    ...
    set title "Lamda = 0.50 Snailshell FC20 Part 1/2"
    plot "Snailshell-Lamda-050-FC20-data_calc_u_next.txt" using 2:13 with lines linecolor black title "tang-accn"

    set xrange [ 0.70 :  + 0.80]
    set yrange [ -60.00 :  +60.00]
    set title "... continue Lamda = 0.50 Snailshell FC20 Part 2/2"
    plot "Snailshell-Lamda-050-FC20-data_calc_u_next.txt" using 2:13 with lines linecolor black title "tang-accn"

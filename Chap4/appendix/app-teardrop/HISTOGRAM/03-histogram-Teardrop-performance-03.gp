...
## ==================================================================
set title "Teardrop Performance 03 (SAA/SCL) for each curve \n at Feedrate Commands FC10, FC20, FC30 and FC40 \n with all lamda = 0.18" 

set xlabel "Run Type"
set ylabel "Arc-Area per Chord-Length (mm)"
...
set yrange [ 0.0 : 1.2E-4] noreverse writeback
...
plot 'data-Teardrop-histogram-performance-03.txt' using 1:xtic(1) title "RUN-TYPE", '' using 2 title "[FC10 Teardrop L0.18]", '' using 3 title "[FC20 Teardrop L0.18]", '' using 4 title "[FC30 Teardrop L0.18]", '' using 5 title "[FC40 Teardrop L0.18]"

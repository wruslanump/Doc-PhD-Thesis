...
# CHANGE PART 1 OF 3
set output "TEARDROP-FC10-Colored-Feedrate-Profile-data_ngcode.png"

# CHANGE PART 2 OF 3
set title  "Teardrop FC10 Feedrate Colored Profile  (Color scale = Feedrate)" 
...
## CHANGE PART 3 OF 3
plot  'FC10-data_ngcode.ngc' using 5:7:3 with lines linewidth 2 linecolor palette title "(x(u), y(u)) point"

...
## ==================================================================
set title "Teardrop Performance 02 (SCE/SCL) for each curve \n at Feedrate Commands FC10, FC20, FC30 and FC40 \n with all lamda = 0.18" 

set xlabel "Run Type"
set ylabel "Chord-Error per Chord-Length"
...
plot 'data-Teardrop-histogram-performance-02.txt' using 1:xtic(1) title "RUN-TYPE", '' using 2 title "[FC10 Teardrop L0.18]", '' using 3 title "[FC20 Teardrop L0.18]", '' using 4 title "[FC30 Teardrop L0.18]", '' using 5 title "[FC40 Teardrop L0.18]"
